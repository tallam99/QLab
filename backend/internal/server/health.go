...
// healthq is a liveness probe: 200 means the process is up and able to respond.
// It deliberately checks nothing beyond the server itself — datastore health is
// the readiness probe's job (see readyq).
func (s *Server) healthq(w http.ResponseWriter, _ *http.Request) {

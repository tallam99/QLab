...
// readyq is the readiness probe: 503 until the service has initialized its
// dependencies (Ready), 200 afterward. Liveness (/healthq) is up from the
...
func (s *Server) readyq(w http.ResponseWriter, _ *http.Request) {
